...
INSTR = (
    ...
    "- FÓRMULA DE ABERTURA DO EVANGELHO trocada: o folheto imprime 'Proclamação do "
    "Evangelho…' OU 'Conclusão do Evangelho…' (esta quando é a perícope final do "
    "Evangelho, ex.: Mt 28,16-20). Se a montagem trocar uma pela outra, É CRÍTICO "
    "(fidelidade ao impresso);\n"
    "- número de versículo trocado (ex.: o 1º versículo impresso é o 2 e a montagem pôs 1).\n\n"
