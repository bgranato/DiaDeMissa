    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="ds-container py-6 ds-bottom-nav-padding ds-home-bottom-nav-padding flex flex-col gap-5">
      ...
      {missa ? (
        ...
        <Card className="ds-card-feature ds-card-unavailable overflow-hidden relative">
          <div className="relative z-10 flex flex-col items-center text-center gap-2 pt-0.5 pb-1.5">
            ...
            <p className="ds-body-sm text-brand-text/70 dark:text-brand-white/70 max-w-none px-1">
      ...
      <footer className="flex flex-wrap justify-center gap-x-4 gap-y-2 px-2 text-center text-xs font-semibold text-brand-slate/70 dark:text-brand-white/60">
        ...
        <a className="underline decoration-brand-gold/60 underline-offset-4 hover:text-brand-blue dark:hover:text-brand-gold" href="/politica-de-cookies.html">Política de cookies</a>
      </footer>
