  ...
  useEffect(() => {
    ...
    function render() {
      ...
      id.renderButton(googleBtnRef.current, {
        ...
        logo_alignment: 'center', locale: 'pt-BR', width: 320,
      })
    }
        ...
        {(modo === 'login' || modo === 'cadastro') && (
          <div className="mt-6 flex flex-col gap-3">
            ...
            {GOOGLE_CLIENT_ID ? (
              ...
              <button disabled
                className="flex items-center justify-center gap-3 w-full bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-[24px] px-8 py-5 font-bold text-lg opacity-60 cursor-not-allowed shadow-soft min-h-[68px]">
