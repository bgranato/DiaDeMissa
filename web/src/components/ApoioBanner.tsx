...
export function ApoioBanner({ onApoiar }: { onApoiar: () => void }) {
  return (
    <section className="ds-home-support-banner relative left-1/2 w-screen -translate-x-1/2 overflow-hidden bg-brand-blue text-white">
      ...
      <div className="ds-container relative flex flex-col gap-5 py-8 sm:flex-row sm:items-center sm:justify-between sm:gap-8 sm:py-9">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 max-w-md text-sm leading-relaxed text-white/80">Se este serviço é útil para você, contribua com o projeto doando 5, 10 ou 15 Reais.</p>
            <p className="mt-2 max-w-md text-sm leading-relaxed text-white/80">É um valor simbólico mas de grande ajuda para nós.</p>
          </div>
        </div>
        <button
          type="button"
