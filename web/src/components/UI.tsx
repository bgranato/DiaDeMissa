...
export const BottomNav = ({
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-brand-blue border-t border-white/5 pb-safe shadow-2xl overflow-hidden">
        ...
        {showMais && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div
              ...
              className="max-h-[calc(100dvh-1.5rem)] w-full max-w-lg overflow-y-auto rounded-[32px] bg-white pb-safe dark:bg-slate-900 sm:max-h-[calc(100dvh-3rem)]"
